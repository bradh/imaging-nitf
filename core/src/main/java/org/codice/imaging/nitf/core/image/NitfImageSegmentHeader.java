...
public interface NitfImageSegmentHeader extends CommonNitfSubSegment {
     ...
     */
    void setImageSegmentDataLength(final long length);
     ...
     */
    void setImageDateTime(final NitfDateTime dateTime);
     ...
     */
    void setSecurityMetadata(final NitfSecurityMetadata nitfSecurityMetadata);
