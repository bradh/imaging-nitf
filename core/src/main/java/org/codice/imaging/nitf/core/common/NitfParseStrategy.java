...
public interface NitfParseStrategy {
     ...
     */
    void handleTextSegment(final NitfReader reader, final int i) throws ParseException;
     ...
     * @throws ParseException if there is a problem handling the segment
     */
    void handleImageSegment(final NitfReader reader, final int i) throws ParseException;
     ...
     * @throws ParseException if there is a problem handling the segment
     */
    void handleLabelSegment(final NitfReader reader, final int i) throws ParseException;
