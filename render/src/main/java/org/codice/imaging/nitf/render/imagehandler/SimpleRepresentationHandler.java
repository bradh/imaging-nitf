...
/**
 * ImageRepresentationHandler for non-mapped single bands cases.
 */
public class SimpleRepresentationHandler implements ImageRepresentationHandler {

    public SimpleRepresentationHandler() {
    }
